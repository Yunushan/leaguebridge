...
var engineeringContract = []categoryContract{
	{
		...
		Subcriteria: []subcriterionContract{
			...
			{ID: "scope-explicit-limitations", Name: "Explicit limitations", Weight: 3, EvidenceType: RepositoryContentV1, VerifierID: "docs-explicit-limitations-v1", Paths: []string{"docs/SUPPORT_POLICY.md", "docs/READINESS.md", "docs/RELEASE_ASSESSMENT.md", "docs/PACKAGING.md", "docs/PRODUCTION_ASSESSMENT_V4_DESIGN.md"}},
			{ID: "scope-primary-source-research", Name: "Dated primary-source research", Weight: 3, EvidenceType: RepositoryContentV1, VerifierID: "docs-primary-source-research-v1", Paths: []string{"docs/research/2026-08-26-platform-feasibility.md", "docs/research/2026-09-23-route-revalidation.md"}},
		},
	},
	{
	...
	},
	{
		...
		Subcriteria: []subcriterionContract{
			{ID: "architecture-versioned-schemas", Name: "Versioned schemas", Weight: 5, EvidenceType: RepositoryContentV1, VerifierID: "schemas-offline-conformance-v1", Paths: []string{"schemas/compatibility-manifest.schema.json", "schemas/config.schema.json", "schemas/evidence-signature-envelope.schema.json", "schemas/evidence-trust-policy.schema.json", "schemas/package-manifest.schema.json", "schemas/readiness-scorecard.schema.json", "schemas/readiness-promotion-v4.schema.json", "schemas/validation-evidence-v2.schema.json", "schemas/validation-evidence.schema.json", "schemas/ci-attestation.schema.json", "schemas/native-package-staging.schema.json", "schemas/native-runtime-attestation.schema.json", "schemas/native-package-attestation.schema.json", "schemas/release-assessment.schema.json", "schemas/production-assessment.schema.json"}},
